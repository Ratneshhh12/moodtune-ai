...
def resolve_yt_audio():
    ...
    try:
        ...
        logger.info(f"Resolving YouTube audio stream using pytubefix: {resolve_target}")
        yt = YouTube(resolve_target)
        ...
        if stream and stream.url:
            ...
            raise Exception("No audio stream found in pytubefix")
